  ...
  module V7
    class EntityAttributes < Grape::API
      ...
      namespace :entity_attributes do 
        ...
        get do 
          present :comment, [:content, :author, :item, :current_user_likes, :likers_count, :dislikers_count, :created_at, :updated_at].sort
          ...
          present :tag, [:name, :short_name, :items, :type].sort
