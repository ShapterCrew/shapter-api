    ...
    class EntityAttributes < Grape::API
      ...
      namespace :entity_attributes do 
        ...
        get do 
          ...
          present :formation_page, [:best_comments, :best_comments_count, :students_count, :comments_count, :diagrams_count, :img_url, :name, :website_url, :description, :sub_formations].sort
