    ...
    class EntityAttributes < Grape::API
      ...
      namespace :entity_attributes do 
        ...
        get do 
          ...
          present :school, [:best_comments, :best_comments_count, :students_count, :comments_count, :diagrams_count, :img_url, :fill_rate, :name, :short_name, :website_url, :description].sort
