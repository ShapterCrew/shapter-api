  ...
  describe "users routes" do 
    ...
    describe "get" do 
      ...
      it "should fucking work" do 
        get "users/me/signup-funnel/1", :school_id => @user.schools.first.id.to_s
        a = JSON.parse(@response.body)
        ...
        get "users/me/signup-funnel/2", :school_id => @user.schools.first.id.to_s
        a = JSON.parse(@response.body)
        a["name"].should == "bar"

        get "users/me/signup-funnel/20", :school_id => @user.schools.first.id.to_s
        a = JSON.parse(@response.body)
